## Include atuin in your zsh xxh plugin
1. Fork this repo
...
4. Push your commits and rename your repo to `xxh-plugin-zsh-atuin`
5. Install the plugin to your xxh home:
```
xxh +I xxh-plugin-zsh-atuin+git+https://github.com/yourname/xxh-plugin-zsh-atuin
```
6. Try to connect in update mode: `xxh [user@]host[:port] +s zsh +if`
